...
<section class="py-16 bg-gray-50 min-h-screen">
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
            ...
            <div class="relative aspect-square overflow-hidden rounded-xl bg-gray-200 group shadow-sm border border-gray-100 cursor-pointer" onclick="openModal('{{ Storage::url($image->image) }}')">
